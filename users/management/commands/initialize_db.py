...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        admin_role, _ = Roles.objects.get_or_create(
            nombre_rol="Administrador", defaults={"estado_Rol": True}
        )

        # 2. Crear Permisos
        permisos_data = [
            {
                "nombre_permiso": "registrarUsuarios",
                "descripcion": "Permite registrar usuarios",
            },
            {
                "nombre_permiso": "registrarRoles",
                "descripcion": "Permite registrar roles",
            },
            ...
            {
                "nombre_permiso": "registrarVenta-DetalleVenta-Empleado",
                "descripcion": "a",
            },
            {
                "nombre_permiso": "registrarVenta-Empleado",
                "descripcion": "Permite al empleado registrar ventas",
            },
            {
                "nombre_permiso": "registrarVenta-DetalleVenta-Administrador",
                "descripcion": "Administrador puede vender con detalle",
            },
            {
